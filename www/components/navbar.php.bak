<nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav ml-auto">
        <li class="nav-item d-none d-sm-inline-block">
            <a href="?s=admin" class="nav-link">Admin Panel (ADM ONLY)</a>
        </li>
    </ul>
</nav>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <ul>
            ...
            <li>Erstellen der Relationen</li>
        </ul>
        </p>
        <br>
        Lucas Mächler - uknwn#0001
        <ul>
            <li>Anpassung der Datenbank-Tabellen für die GUI</li>
            <li>Einbindung von Bootstrap und AdminLTE</li>
            <li>Programmierung eines eigenes PHP Framework</li>
            <li>DB-Anbindung</li>
        </ul>
        <br>
        Software
